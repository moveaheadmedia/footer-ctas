...
use FooterCtas\Common\Traits\Singleton;
...
final class Plugin {
	...
	public function data(): array {
		$plugin_data = apply_filters( 'footer_ctas_plugin_data', [
			'settings'               => get_option( 'footer-ctas-settings' ),
			'plugin_path'            => untrailingslashit(
				plugin_dir_path( FOOTER_CTAS_PLUGIN_FILE )  // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
			),
			'plugin_template_folder' => 'templates',
			'ext_template_folder'    => 'footer-ctas-templates',
			/**
			 * Add extra data here
			 */
		] );
		return array_merge(
			apply_filters( 'footer_ctas_plugin_meta_data',
				get_file_data( FOOTER_CTAS_PLUGIN_FILE, // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
					[
						'name'         => 'Plugin Name',
						'uri'          => 'Plugin URI',
